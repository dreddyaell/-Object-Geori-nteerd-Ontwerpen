...
public class Presentation {
	...
	public void setSlideNumber(int number) {
		if (getSize() == 0) { // Controleer of er slides beschikbaar zijn
			return; // Voorkomt de foutmelding bij het opstarten
		}
		if (number < 0 || number >= getSize()) { // Controleer of de slide bestaat
			JOptionPane.showMessageDialog(null,
					"Slide " + (number + 1) + " bestaat niet! Kies een geldige slide.",
					"Fout",
